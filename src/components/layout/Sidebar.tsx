...
import {
  ...
  CreditCard, Award, TrendingUp, PieChart, FileBarChart, Target, Clock, Zap, Plus as PlusBase
} from 'lucide-react';
          ...
          return (
            ...
            >
              <motion.button
                ...
                className={`w-full flex items-center px-4 py-3 text-sm font-display font-semibold text-gray-700 dark:text-gray-300 hover:bg-white/50 dark:hover:bg-gray-800/50 rounded-xl transition-all duration-200 backdrop-blur-sm group ${expandedGroups.includes(group.name) && !isCollapsed ? 'bg-white/30 dark:bg-gray-800/30 shadow-sm' : ''
                  }`}
