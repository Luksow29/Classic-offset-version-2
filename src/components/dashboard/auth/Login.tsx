...
const Logo = ({ className, light = false }: { className?: string, light?: boolean }) => (
  ...
  >
    <div className={`w-14 h-14 rounded-full flex items-center justify-center overflow-hidden bg-white shadow-sm`}>
      <img src="/classic-offset-logo.jpg" alt="Logo" className="w-full h-full object-cover" />
    </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2">
                  {isSignUp ? 'Start managing your printing business' : 'Enter your details to access your dashboard'}
                </p>
              </motion.div>
            </AnimatePresence>
          </motion.div>
