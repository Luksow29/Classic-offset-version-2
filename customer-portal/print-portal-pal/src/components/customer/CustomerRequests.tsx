                                    ...
                                    <li key={req.id} className="p-3 bg-muted/50 rounded-lg border">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">{req.request_data.quantity} x {req.request_data.orderType}</p>
                                                 <p className="text-xs font-bold text-primary">₹{req.request_data.totalAmount?.toLocaleString() || 'N/A'}</p>
                                            </div>
