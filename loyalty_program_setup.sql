-- SQL to create Advanced Loyalty Program database tables
...
-- Add loyalty columns to existing customers table
...
-- Verify the loyalty system structure
SELECT 
    table_name,
    column_name, 
    data_type, 
...
WHERE table_name IN ('loyalty_tiers', 'loyalty_points', 'loyalty_rewards', 'loyalty_redemptions', 'loyalty_referrals')
